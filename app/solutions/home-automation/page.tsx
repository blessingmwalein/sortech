        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start mt-20">
          ...
          <div className="space-y-8 order-2 md:order-1">
            <div>
              ...
              <p className="text-gray-600">
                We can help you deliver the right level of comfort in your home. We integrate shades, pool and spa control, and fireplace switches to bring a new level of comfort to your smart home. Door stations keep you connected to your home from anywhere.
              </p>
            </div>
            <div>
              <h3 className="text-xl font-semibold mb-2">Safety and security</h3>
              <p className="text-gray-600">
                By integrating with the leading brands in security cameras, NVRs, smart locks, and sensors, you can monitor your house 24/7 and be notified immediately if a door opens, the water heater leaks, or if you left the garage door open.
              </p>
            </div>
          </div>
